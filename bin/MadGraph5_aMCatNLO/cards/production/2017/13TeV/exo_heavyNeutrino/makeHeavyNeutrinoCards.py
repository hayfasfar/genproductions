...
if __name__ == "__main__":
  combinations = [
    ...
    (1,     0.11505,     'mu',  True,    True,  'samesign'),
    (1,     0.11505,     'mu',  True,    True,  'trilepton')
  ]

  for mass, coupling, flavour, spinmode, isPre2017, type in combinations:
    makeHeavyNeutrinoCards(mass, coupling, flavour, spinmode, isPre2017, type)
